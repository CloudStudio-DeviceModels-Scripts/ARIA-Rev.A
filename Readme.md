...
# Parsing + Configuration Script – ARIA - Rev. A

This **Parsing + Configuration** script is designed for the **ARIA** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – ARIA Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **ARIA** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).

...
# Configuration Script – ARIA - Rev. A

This **Configuration** script is designed for the **ARIA** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – ARIA Rev. A

Este script de **Configuration** está diseñado para el modelo **ARIA** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
